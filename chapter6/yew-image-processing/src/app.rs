        ...
        match msg {
            Msg::LoadFile(files) => {
                ...
                let callback = Closure::wrap(Box::new(move || {
                    ...
                    context
                        .draw_image_with_html_image_element(&image_clone, 0.0, 0.0)
                        .unwrap();
                }) as Box<dyn Fn()>);
            ...
            Msg::Shrink => {
                ...
                let output_image_data = web_sys::ImageData::new_with_u8_clamped_array(
                ...
                context
                    .put_image_data(&output_image_data, 0.0, 0.0)
                    .unwrap();
            }
        }
        true
